...
<c:forEach items="${list }" var="dto" varStatus="cnt">
	<tr><td  width=10% ><a href="goodsDetail.gd?goodsNum=${dto.goodsNum }">${dto.goodsNum }
	</a></td>
	    <td  width=40%>
	    <img width="50" src="../goodsView/upload/${dto.goodsImage }" /></td>
	    <td  width=20%>${dto.goodsName }</td>
	    <td  width=10%>
	    <fmt:formatNumber value="${dto.goodsPrice }" type="currency"></fmt:formatNumber></td></tr>
</c:forEach>
