...
<c:forEach items="${cartList }" var="dto" varStatus="cnt">
	<tr align="center" bgcolor="orange">
		<td>${cnt.count }</td>
		<td><img src = "../goodsView/upload/${dto.goodsImage }" width="30"/></td>
		<td>${dto.goodsName }</td>
		<td><fmt:formatNumber value="${dto.goodsPrice }" type="currency"></fmt:formatNumber></td>
...
<table align="center" width="600" border="0">
	<tr align="center" bgcolor="yellow">
		...
		<font color ="gray" size="5">총 결제금액 : <fmt:formatNumber value="${cartList[0].sumTotalPrice }" type="currency"></fmt:formatNumber></font>
