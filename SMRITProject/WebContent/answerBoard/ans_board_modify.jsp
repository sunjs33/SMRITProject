...
<script type="text/javascript" 
	...
	$(function() {
		$("#btn").click(function() {
			if($(this).attr("value")=="삭제"){ // 현재 버튼이 삭제 라면
				$(this).attr("value","삭제취소") // 삭제취소로 변경
...
<body>
<form action="answerBoardModifyPro.ans" method="post" name="modifyform" enctype="multipart/form-data">
...
<table cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td>
			<input name="boardSubject" size="50" maxlength="100" value="${dto.boardSubject }">
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td>파일</td>
		<td>
			원본파일명 : ${dto.originalFileName }<br/>
			저장된 파일명 : ${dto.storeFileName }
