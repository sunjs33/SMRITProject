...
<table border = 1  width = 600 align = "center" cellpadding = 3 >
	...
	<tr><td> 생년월일 및 성별</td>
		<td><fmt:formatDate value="${memberDTO.userBirth }" type="date" 
		pattern="yyyy-MM-dd"/>
		/
			<c:if test="${memberDTO.userGender == 'M'}">남자</c:if> 
	...
	<tr><td>사용자 이메일</td>
	    <td><input type ="text" id ="email" name ="userEmail" 
	        value = "${memberDTO.userEmail }"/></td></tr>
	<tr><td>사용자 주소</td>
	    <td>
